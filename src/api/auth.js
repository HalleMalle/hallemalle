...
export async function ensureUserDoc(firebaseUser, additionalUserInfo = null) {
  ...
  const userData = {
    ...
    github_commit_contributions: 0,
    github_pr_contributions: 0,
    github_review_contributions: 0,
    github_issue_contributions: 0,
    github_followers: 0,
    github_stars: 0,
    github_language_json: {},
    github_language_source: "COMMIT_FILES",
    github_framework_json: {},
    github_framework_evidence: {},
    github_framework_source: "COMMIT_FILES_AND_DEPENDENCIES",
    github_commit_file_stats: {},
